...
name: vector-venue
version: 2.0.0
description: "Phase 6 skill for VECTOR. Defines where the offer is sold, how the product is packaged, and what trust must exist before launch. Owns ALL venue-specific fields — thesis.md does not."
---
