...
- Có ít nhất 1 intent signal (xem phần Intent Signal)
...
| Iterate | Green/Yellow signal nhưng chưa convert | Chọn 1 layer để thay đổi (xem Loop-Back Routing Table) |
