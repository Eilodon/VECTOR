...
name: vector-thesis
version: 2.0.0
description: "Phase 5 skill for VECTOR. Commits to a primary channel, defines the growth multiplier, and builds the thesis card. Thesis card does NOT contain venue-specific fields — those belong to venue."
---
...
- Sales venue cụ thể (→ venue skill)
- Product architecture / tiers (→ venue skill)
- Trust signal cụ thể cần thiết (→ venue skill)
- Primary CTA (→ venue skill)
- ICP drift check (→ venue skill)
...
**NOTE: Thesis card KHÔNG chứa sales venue, product architecture, trust signal, primary CTA, hay ICP drift check.**

---

## Gate Checklist — Thesis → Venue
