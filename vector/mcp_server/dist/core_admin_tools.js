export function registerAdminTools(deps) {
    deps.registerVectorTool("vector_list_toolsets", {
    ...
    deps.registerVectorTool("vector_list_toolset_tools", {
        description: "List the tools that belong to a VECTOR capability toolset.",
        inputSchema: {
            toolset: deps.zod.enum(deps.allCapabilityToolsets()).describe("Capability toolset to inspect."),
        },
    }, async ({ toolset }) => {
    ...
    deps.registerVectorTool("vector_undo", {
    ...
    deps.registerVectorTool("vector_update_state", {
        ...
        const cleaned = deps.sanitizeRecursive(patch);
        ...
        return deps.emit("vector_update_state", {
    ...
    deps.registerVectorTool("vector_state_snapshot", {
