import { RawSourcePayloadSchema, SearchProviderDescriptorSchema, SearchProviderResponseSchema, } from "./research_provider_contract.js";
...
function normalizeWhitelist(sourceWhitelist, providerWhitelist) {
...
function scoreDocumentAgainstQuery(document, query) {
    const haystack = [
        document.title,
        document.claim,
        document.relevance,
...
async function fetchJson(url, init, providerLabel) {
...
export function getResearchProviderRegistry() {
    return registry;
}
...
export function defaultSearchProviderId() {
